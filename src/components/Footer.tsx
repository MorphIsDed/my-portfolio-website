...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="py-20 border-t border-slate-800/60">
      <div className="content-container px-6 flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a
            href="#hero"
            className="text-3xl font-black tracking-tighter hover:text-gradient transition-colors mb-4 flex items-center gap-1"
          >
             <span className="w-8 h-8 rounded-lg flex items-center justify-center text-white text-base bg-gradient-to-tr from-sky-500 via-fuchsia-500 to-emerald-400 neon-ring">A</span>
